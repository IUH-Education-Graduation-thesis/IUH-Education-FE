  ...
  const renderForm = () => {
    return (
      ...
      >
        ...
        <Form.Item name="ngayBatDau" label="Ngày bắt đầu" rules={[{ required: true, message: 'Yêu cầu chọn ngày bắt đầu năm học!' }]}>
          <DatePicker
            onChange={(date, dateString) => handleChangeNgay('ngayBatDau', date, dateString)}
            placeholder='Ngày bắt đầu' />
        </Form.Item>
        <Form.Item name="ngayKetThuc" label="Ngày kết thúc" rules={[{ required: true, message: 'Yêu cầu chọn ngày kết thúc năm học!' }]}>
          <DatePicker
